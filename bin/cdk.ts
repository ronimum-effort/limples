...
import { FoundationStack } from '../src/yeptep'
...
const dockerCredentials = app.node.tryGetContext('dockerhubCredentialsPath')
new FoundationStack(app, 'yeptep', {
  dockerhubCredentialsPath: dockerCredentials,
})
